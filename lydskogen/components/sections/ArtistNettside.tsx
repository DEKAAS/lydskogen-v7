...
export default function ArtistNettsideSection() {
  ...
  return (
    <section id="artist" className="relative py-20 overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-2 h-2 bg-accent-green/20 rounded-full"
            style={{
